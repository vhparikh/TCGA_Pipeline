...
wt = pd.read_csv('../../LGG/LGG_Subtypes/IDHwt_top_20.csv')['GENE']
non_codel = pd.read_csv('../../LGG/LGG_Subtypes/IDHmut-non-codel_top_20.csv')['GENE']
codel = pd.read_csv('../../LGG/LGG_Subtypes/IDHmut-codel_top_20.csv')['GENE']

allgenes = pd.read_csv('../../LGG/LGG_Subtypes/IDHwt.csv')['GENE']

#genelist = []
all_subtypes = pd.concat([codel, wt, non_codel])
unique_genes = all_subtypes.unique()
unique_genes = list(unique_genes)
dataframe_short = pd.read_csv('../../LGG/LGG.csv', usecols=[*unique_genes, 'SUBTYPE'])
...
dataframe_full = pd.read_csv('../../LGG/LGG.csv', usecols=[*allgenes, 'SUBTYPE'])
...
lut = dict(zip(subtype.unique(), ['#A8D4AD', '#92B9BD', '#E8EC67']))
